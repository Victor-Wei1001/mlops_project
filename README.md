...
**Course 02476 MLOps - Exam Project**

## Project Description

In this project, we want to build a translator that converts **English to Chinese**. We will fine-tune the **T5-small model** using a subset of the **Helsinki-NLP/opus-100 dataset**. This dataset is a collection of parallel corpora providing high-quality sentence pairs for machine translation tasks.
...
* **Black and Flake8** for ensuring code quality and PEP8 compliance.
